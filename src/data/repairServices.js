  ...
  'macbook': {
    ...
    services: [
      ...
      { id: 'motherboard-repair', title: '主板/逻辑板维修', titleEn: 'Logic Board Repair',
        ...
        imageHint: 'board' },
      { id: 'cleaning', title: '清灰换硅脂/散热', titleEn: 'Cleaning & Cooling', prices: '100¥起 (from $14)', description: 'MacBook风扇狂转、机身发烫、性能下降。深度清灰+换导热硅脂，有效降温10-20°C。', descriptionEn: 'Loud fans, overheating, performance drop. Deep clean + thermal paste, lowers temps 10-20°C.', details: 'MacBook深度拆机清灰、更换导热硅脂，有效降低温度10-20°C，告别风扇狂转。笔记本台式机都做。\n\n维修时间：约1小时。', detailsEn: 'Deep clean, thermal paste replacement, lowers temp 10-20°C. Laptop & desktop.\n\nTime: ~1hr.', imageHint: '' },
  ...
  'samsung': {
    ...
    services: [
      ...
      { id: 'battery-replacement', title: '电池更换', titleEn: 'Battery Replacement',
        ...
        imageHint: 'battery' },
      { id: 'motherboard-repair', title: '主板维修', titleEn: 'Motherboard Repair', prices: '150¥起 (from $20)', description: 'Samsung不开机、重启、充电IC故障、无服务、WiFi打不开。三星主板芯片级维修。', descriptionEn: 'No power, boot loop, charging IC, no service, WiFi dead. Component-level Samsung board repair.', details: '三星手机主板芯片级维修。不开机、无服务、无序号、充电IC、WiFi灰点。比换主板便宜很多。\n\n维修时间：1-3天。', detailsEn: 'Samsung component-level board repair. No power, no service, no IMEI, charging IC, WiFi grayed. Much cheaper than board swap.\n\nTime: 1-3 days.', imageHint: 'board' },
      { id: 'charging-port', title: '充电口/尾插', titleEn: 'Charging Port', prices: '80¥起 (from $10)', description: 'Samsung充电口松动、接触不良、Type-C不识别、只能一个方向充。', descriptionEn: 'Loose port, bad contact, Type-C not recognized, one-way charging only.', details: '充电口松动、接触不良、Type-C不识别、只能一个方向充。尾插小板/排线更换。\n\n维修时间：约30分钟-1小时。', detailsEn: 'Loose port, bad contact, Type-C not recognized, one-way charging. Flex replacement.\n\nTime: 30min-1hr.', imageHint: 'port' },
      { id: 'camera-repair', title: '摄像头维修', titleEn: 'Camera Repair', prices: '100¥起 (from $15)', description: '拍照模糊、闪退、黑屏、对焦失灵。Samsung Galaxy全系前后摄像头更换。', descriptionEn: 'Blurry photos, crash, black screen, autofocus fail. Samsung Galaxy front/back camera.', details: '拍照模糊、闪退、黑屏、对焦失灵。前后摄像头更换。\n\n适用Samsung Galaxy S/Z/A全系。\n维修时间：约1小时。', detailsEn: 'Blurry photos, crash, black screen, autofocus fail. Front & rear camera replacement.\n\nSamsung Galaxy S/Z/A series.\nTime: ~1hr.', imageHint: 'camera' },
