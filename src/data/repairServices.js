...
const repairServices = {
  ...
  'macbook': {
    ...
    services: [
      ...
      { id: 'motherboard-repair', title: '主板/逻辑板维修', titleEn: 'Logic Board Repair',
        ...
        imageHint: 'board' },
      { id: 'cleaning', title: '清灰换硅脂/散热', titleEn: 'Cleaning & Cooling', description: 'MacBook风扇狂转、机身发烫、性能下降。深度清灰+换导热硅脂，有效降温10-20°C。', descriptionEn: 'Loud fans, overheating, performance drop. Deep clean + thermal paste, lowers temps 10-20°C.', details: 'MacBook深度拆机清灰、更换导热硅脂，有效降低温度10-20°C，告别风扇狂转。笔记本台式机都做。', detailsEn: 'Deep clean, thermal paste replacement, lowers temp 10-20°C. Laptop & desktop.', imageHint: '' },
  ...
  'samsung': {
    ...
    services: [
      ...
      { id: 'battery-replacement', title: '电池更换', titleEn: 'Battery Replacement',
        ...
        imageHint: 'battery' },
      { id: 'motherboard-repair', title: '主板维修', titleEn: 'Motherboard Repair', description: 'Samsung不开机、重启、充电IC故障、无服务、WiFi打不开。三星主板芯片级维修。', descriptionEn: 'No power, boot loop, charging IC, no service, WiFi dead. Component-level Samsung board repair.', details: '三星手机主板芯片级维修。不开机、无服务、无序号、充电IC、WiFi灰点。比换主板便宜很多。', detailsEn: 'Samsung component-level board repair. No power, no service, no IMEI, charging IC, WiFi grayed. Much cheaper than board swap.', imageHint: 'board' },
      { id: 'charging-port', title: '充电口/尾插', titleEn: 'Charging Port', description: 'Samsung充电口松动、接触不良、Type-C不识别、只能一个方向充。', descriptionEn: 'Loose port, bad contact, Type-C not recognized, one-way charging only.', details: '充电口松动、接触不良、Type-C不识别、只能一个方向充。尾插小板/排线更换。', detailsEn: 'Loose port, bad contact, Type-C not recognized, one-way charging. Flex replacement.', imageHint: 'port' },
      { id: 'camera-repair', title: '摄像头维修', titleEn: 'Camera Repair', description: '拍照模糊、闪退、黑屏、对焦失灵。Samsung Galaxy全系前后摄像头更换。', descriptionEn: 'Blurry photos, crash, black screen, autofocus fail. Samsung Galaxy front/back camera.', details: '拍照模糊、闪退、黑屏、对焦失灵。前后摄像头更换。\n\n适用Samsung Galaxy S/Z/A全系。', detailsEn: 'Blurry photos, crash, black screen, autofocus fail. Front & rear camera replacement.\n\nSamsung Galaxy S/Z/A series.\nTime: ~1hr.', imageHint: 'camera' },
  ...
  'huawei': {
    ...
    services: [
      ...
      { id: 'flash-unlock', title: '刷机/解锁', titleEn: 'Flash / Unlock',
        ...
        imageHint: 'flash' },
      { id: 'motherboard-repair', title: '主板维修', titleEn: 'Motherboard Repair', description: '华为不开机、重启、充电IC、无服务、WiFi打不开。芯片级维修。', descriptionEn: 'Huawei no power, boot loop, IC fault. Component-level board repair.', details: '华为/荣耀主板芯片级维修。充电IC、显示IC、不开机、重启、无服务。', detailsEn: 'Huawei/Honor component-level board repair. Charging IC, display IC, no power, boot loop.', imageHint: 'board' },
      ...
      { id: 'back-glass', title: '后盖/边框', titleEn: 'Back Glass/Frame', description: '华为玻璃后盖碎裂、中框变形。P系列/Mate系列后盖更换。', descriptionEn: 'Huawei glass back broken, frame bent. P/Mate series back glass replacement.', details: '华为玻璃后盖更换。P系列/Mate系列/Nova系列后盖都有。换后打密封胶恢复防水。', detailsEn: 'Huawei glass back replacement for P/Mate/Nova series. Waterproof sealant restored.', imageHint: 'backglass' },
    ]
  },
  'lenovo': {
    brand: 'Lenovo',
    ...
    gradient: 'from-blue-700 via-blue-600 to-blue-500',
    services: [
      { id: 'screen-replacement', title: '屏幕更换', titleEn: 'Screen Replacement', description: '联想屏幕碎裂', descriptionEn: 'Lenovo cracked screen', details: '联想全系列屏幕更换。', detailsEn: 'Lenovo screen replacement.', imageHint: 'screen' },
      { id: 'battery-replacement', title: '电池更换', titleEn: 'Battery Replacement', description: '电池鼓包', descriptionEn: 'Battery swelling', details: '电池更换。', detailsEn: 'Battery replacement.', imageHint: 'battery' },
      { id: 'keyboard-repair', title: '键盘维修', titleEn: 'Keyboard Repair', description: '键盘失灵', descriptionEn: 'Keyboard issues', details: '键盘更换或修复。', detailsEn: 'Keyboard fix.', imageHint: 'keyboard' },
      { id: 'cleaning', title: '清灰换硅脂', titleEn: 'Cleaning & Cooling', description: '清灰换硅脂', descriptionEn: 'Deep clean', details: '风扇狂转发热降频。', detailsEn: 'Overheating clean.', imageHint: '' },
      { id: 'os-upgrade', title: '系统重装/升级', titleEn: 'OS/Upgrade', description: '重装系统升级', descriptionEn: 'OS reinstall upgrade', details: '系统重装、加固态。', detailsEn: 'OS reinstall, SSD upgrade.', imageHint: '' },
  ...
  'dell': {
    ...
    services: [
      { id: 'screen-replacement', title: '屏幕更换', titleEn: 'Screen Replacement', description: '戴尔屏幕碎裂', descriptionEn: 'Dell cracked screen', details: '戴尔全系列屏幕更换。', detailsEn: 'Dell screen replacement.', imageHint: 'screen' },
      { id: 'battery-replacement', title: '电池更换', titleEn: 'Battery Replacement', description: '电池鼓包', descriptionEn: 'Battery swelling', details: '电池更换。', detailsEn: 'Battery replacement.', imageHint: 'battery' },
      { id: 'keyboard-repair', title: '键盘维修', titleEn: 'Keyboard Repair', description: '键盘失灵', descriptionEn: 'Keyboard issues', details: '键盘更换或修复。', detailsEn: 'Keyboard fix.', imageHint: 'keyboard' },
      { id: 'cleaning', title: '清灰换硅脂', titleEn: 'Cleaning & Cooling', description: '清灰换硅脂', descriptionEn: 'Deep clean', details: '降温降频。', detailsEn: 'Overheating clean.', imageHint: '' },
      { id: 'os-upgrade', title: '系统重装/升级', titleEn: 'OS/Upgrade', description: '重装系统', descriptionEn: 'OS reinstall', details: '系统问题。', detailsEn: 'OS issues.', imageHint: '' },
  ...
  'hp': {
    ...
    services: [
      { id: 'screen-replacement', title: '屏幕更换', titleEn: 'Screen Replacement', description: '惠普屏幕碎裂', descriptionEn: 'HP cracked screen', details: '惠普全系列屏幕更换。', detailsEn: 'HP screen replacement.', imageHint: 'screen' },
      { id: 'battery-replacement', title: '电池更换', titleEn: 'Battery Replacement', description: '电池鼓包', descriptionEn: 'Battery issues', details: '电池更换。', detailsEn: 'Battery replacement.', imageHint: 'battery' },
      { id: 'keyboard-repair', title: '键盘维修', titleEn: 'Keyboard Repair', description: '键盘失灵', descriptionEn: 'Keyboard issues', details: '键盘更换或修复。', detailsEn: 'Keyboard fix.', imageHint: 'keyboard' },
      { id: 'cleaning', title: '清灰换硅脂', titleEn: 'Cleaning & Cooling', description: '清灰换硅脂', descriptionEn: 'Deep clean', details: '过热降频清灰。', detailsEn: 'Overheating fix.', imageHint: '' },
      { id: 'os-upgrade', title: '系统重装/升级', titleEn: 'OS/Upgrade', description: '系统重装', descriptionEn: 'OS reinstall', details: '系统问题。', detailsEn: 'OS issues.', imageHint: '' },
  ...
  'asus': {
    ...
    services: [
      { id: 'screen-replacement', title: '屏幕更换', titleEn: 'Screen Replacement', description: '华硕屏幕碎裂', descriptionEn: 'ASUS cracked screen', details: '华硕屏幕更换。', detailsEn: 'ASUS screen replacement.', imageHint: 'screen' },
      { id: 'battery-replacement', title: '电池更换', titleEn: 'Battery Replacement', description: '电池鼓包', descriptionEn: 'Battery issues', details: '电池更换。', detailsEn: 'Battery replacement.', imageHint: 'battery' },
      { id: 'cleaning', title: '清灰换硅脂', titleEn: 'Cleaning & Cooling', description: '清灰换硅脂', descriptionEn: 'Deep clean', details: 'ROG游戏本清灰必做。', detailsEn: 'ROG gaming laptop cleaning.', imageHint: '' },
      { id: 'keyboard-repair', title: '键盘维修', titleEn: 'Keyboard Repair', description: '键盘失灵', descriptionEn: 'Keyboard issues', details: '键盘更换或修复。', detailsEn: 'Keyboard fix.', imageHint: 'keyboard' },
      { id: 'os-upgrade', title: '系统重装/升级', titleEn: 'OS/Upgrade', description: '重装系统', descriptionEn: 'OS reinstall', details: '系统问题。', detailsEn: 'OS issues.', imageHint: '' },
      { id: 'other-issues', title: '其他故障', titleEn: 'Other Issues', description: '免费检测', descriptionEn: 'Free check', details: '蓝屏免费检测。', detailsEn: 'Free check.', imageHint: '' },
    ]
  ...
  'acer': {
    ...
    services: [
      { id: 'screen-replacement', title: '屏幕更换', titleEn: 'Screen Replacement', description: '宏基屏幕碎裂', descriptionEn: 'Acer cracked screen', details: '宏基屏幕更换。', detailsEn: 'Acer screen replacement.', imageHint: 'screen' },
      { id: 'battery-replacement', title: '电池更换', titleEn: 'Battery Replacement', description: '电池鼓包', descriptionEn: 'Battery swelling', details: '电池更换。', detailsEn: 'Battery replacement.', imageHint: 'battery' },
      { id: 'keyboard-repair', title: '键盘维修', titleEn: 'Keyboard Repair', description: '键盘失灵', descriptionEn: 'Keyboard issues', details: '键盘更换。', detailsEn: 'Keyboard fix.', imageHint: 'keyboard' },
      { id: 'cleaning', title: '清灰换硅脂', titleEn: 'Cleaning & Cooling', description: '清灰换硅脂', descriptionEn: 'Deep clean', details: '散热清洁。', detailsEn: 'Cooling clean.', imageHint: '' },
      { id: 'os-upgrade', title: '系统重装/升级', titleEn: 'OS/Upgrade', description: '重装系统', descriptionEn: 'OS reinstall', details: '系统问题。', detailsEn: 'OS issues.', imageHint: '' },
  ...
  'msi': {
    ...
    services: [
      { id: 'screen-replacement', title: '屏幕更换', titleEn: 'Screen Replacement', description: '微星屏幕碎裂', descriptionEn: 'MSI cracked screen', details: '微星屏幕更换。', detailsEn: 'MSI screen replacement.', imageHint: 'screen' },
      { id: 'battery-replacement', title: '电池更换', titleEn: 'Battery Replacement', description: '电池鼓包', descriptionEn: 'Battery swelling', details: '电池更换。', detailsEn: 'Battery replacement.', imageHint: 'battery' },
      { id: 'cleaning', title: '清灰换硅脂', titleEn: 'Cleaning & Cooling', description: '清灰换硅脂', descriptionEn: 'Deep clean', details: '游戏本清灰必做。', detailsEn: 'Gaming laptop cleaning.', imageHint: '' },
      { id: 'keyboard-repair', title: '键盘维修', titleEn: 'Keyboard Repair', description: '键盘失灵', descriptionEn: 'Keyboard issues', details: '键盘更换。', detailsEn: 'Keyboard fix.', imageHint: 'keyboard' },
      { id: 'os-upgrade', title: '系统重装/升级', titleEn: 'OS/Upgrade', description: '重装系统', descriptionEn: 'OS reinstall', details: '系统问题。', detailsEn: 'OS issues.', imageHint: '' },
  ...
  'surface': {
    ...
    services: [
      { id: 'screen-replacement', title: '屏幕更换', titleEn: 'Screen Replacement', description: 'Surface屏幕碎裂', descriptionEn: 'Surface cracked screen', details: 'Surface Pro/Go/Laptop全系屏幕更换。', detailsEn: 'Surface screen replacement.', imageHint: 'screen' },
      { id: 'battery-replacement', title: '电池更换', titleEn: 'Battery Replacement', description: 'Surface电池鼓包', descriptionEn: 'Surface battery swelling', details: 'Surface电池鼓包通病，尽快更换。', detailsEn: 'Surface battery swelling common issue.', imageHint: 'battery' },
      { id: 'keyboard-repair', title: '键盘盖维修', titleEn: 'Type Cover Repair', description: '键盘盖不灵', descriptionEn: 'Type cover issues', details: 'Surface键盘盖更换或修复。', detailsEn: 'Surface keyboard cover fix.', imageHint: 'keyboard' },
      { id: 'cleaning', title: '清灰换硅脂', titleEn: 'Cleaning & Cooling', description: '清灰', descriptionEn: 'Deep clean', details: '清灰散热。', detailsEn: 'Cooling clean.', imageHint: '' },
      { id: 'os-upgrade', title: '系统重装/升级', titleEn: 'OS/Upgrade', description: '重装系统', descriptionEn: 'OS reinstall', details: '系统问题。', detailsEn: 'OS issues.', imageHint: '' },
      { id: 'other-issues', title: '其他故障', titleEn: 'Other Issues', description: '免费检测', descriptionEn: 'Free check', details: '其他问题免费检测。', detailsEn: 'Free check.', imageHint: '' },
    ]
  },
  'hasee': {
    ...
    services: [
      { id: 'screen-replacement', title: '屏幕更换', titleEn: 'Screen Replacement', description: '神舟屏幕碎裂', descriptionEn: 'Hasee cracked screen', details: '神舟屏幕更换。', detailsEn: 'Hasee screen replacement.', imageHint: 'screen' },
      { id: 'battery-replacement', title: '电池更换', titleEn: 'Battery Replacement', description: '电池鼓包', descriptionEn: 'Battery swelling', details: '电池更换。', detailsEn: 'Battery replacement.', imageHint: 'battery' },
      { id: 'cleaning', title: '清灰换硅脂', titleEn: 'Cleaning & Cooling', description: '清灰换硅脂', descriptionEn: 'Deep clean', details: '游戏本清灰必做。', detailsEn: 'Gaming laptop cleaning.', imageHint: '' },
      { id: 'keyboard-repair', title: '键盘维修', titleEn: 'Keyboard Repair', description: '键盘失灵', descriptionEn: 'Keyboard issues', details: '键盘更换。', detailsEn: 'Keyboard fix.', imageHint: 'keyboard' },
      { id: 'os-upgrade', title: '系统重装/升级', titleEn: 'OS/Upgrade', description: '重装系统', descriptionEn: 'OS reinstall', details: '系统问题。', detailsEn: 'OS issues.', imageHint: '' },
