      ...
      <section className="py-14">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="BACKBTN_placeholder from-blue-600 to-blue-500 text-white rounded-2xl p-5 shadow-md">
            ...
            <div className="BACKBTN_placeholder from-purple-600 to-purple-500 text-white rounded-2xl p-5 shadow-md">
              <div className="text-3xl mb-2">📟</div>
            ...
            <div className="BACKBTN_placeholder from-red-600 to-red-500 text-white rounded-2xl p-5 shadow-md">
              <div className="text-3xl mb-2">📟</div>
            ...
            <div className="BACKBTN_placeholder from-orange-600 to-yellow-500 text-white rounded-2xl p-5 shadow-md">
              <div className="text-3xl mb-2">📟</div>
            ...
            <div className="BACKBTN_placeholder from-teal-600 to-teal-500 text-white rounded-2xl p-5 shadow-md">
              <div className="text-3xl mb-2">📟</div>
            ...
            <div className="BACKBTN_placeholder from-violet-600 to-violet-500 text-white rounded-2xl p-5 shadow-md">
              <div className="text-3xl mb-2">📟</div>
            ...
            <div className="BACKBTN_placeholder from-amber-600 to-amber-500 text-white rounded-2xl p-5 shadow-md">
              <div className="text-3xl mb-2">📖</div>
