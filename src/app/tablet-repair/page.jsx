      ...
      <section className="py-14">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <a href="/tablet-repair/ipad" className="bg-gradient-to-br from-blue-600 to-blue-500 text-white rounded-2xl p-5 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all block">
            ...
            <a href="/tablet-repair/samsung" className="bg-gradient-to-br from-purple-600 to-purple-500 text-white rounded-2xl p-5 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all block">
              <div className="text-3xl mb-2">📟</div>
            ...
            <a href="/tablet-repair/huawei" className="bg-gradient-to-br from-red-600 to-red-500 text-white rounded-2xl p-5 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all block">
              <div className="text-3xl mb-2">📟</div>
            ...
            <a href="/tablet-repair/xiaomi" className="bg-gradient-to-br from-orange-600 to-yellow-500 text-white rounded-2xl p-5 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all block">
              <div className="text-3xl mb-2">📟</div>
            ...
            <a href="/tablet-repair/oppo" className="bg-gradient-to-br from-teal-600 to-teal-500 text-white rounded-2xl p-5 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all block">
              <div className="text-3xl mb-2">📟</div>
            ...
            <a href="/tablet-repair/lenovo" className="bg-gradient-to-br from-violet-600 to-violet-500 text-white rounded-2xl p-5 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all block">
              <div className="text-3xl mb-2">📟</div>
            ...
            <a href="/tablet-repair/kindle" className="bg-gradient-to-br from-amber-600 to-amber-500 text-white rounded-2xl p-5 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all block">
              <div className="text-3xl mb-2">📖</div>
