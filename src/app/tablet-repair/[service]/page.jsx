      ...
      <section className={'bg-gradient-to-br ' + info.gradientBg + ' text-white'}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-14">
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            ...
            <a href={'https://wa.me/6596146709?text=' + encodeURIComponent('咨询' + info.title + '平板维修')} target="_blank" className="bg-green-500 text-white font-semibold text-sm px-5 py-2.5 rounded-xl hover:bg-green-600 shadow-lg">{t('💬 WhatsApp咨询', '💬 WhatsApp')}</a>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex justify-center gap-3">
            ...
            {info.brandPage && (
              <a href={info.brandPage} className="bg-gray-200 text-gray-700 font-semibold px-6 py-3 rounded-xl hover:bg-gray-300 shadow-md">{t('查看全部品牌服务 →', 'View All Brand Services →')}</a>
            )}
          </div>
        </div>
      </section>
