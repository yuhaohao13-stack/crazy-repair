      ...
      <section className="py-14">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="BACKBTN_placeholder from-gray-600 to-gray-500 text-white rounded-2xl p-5 shadow-md">
              <div className="text-3xl mb-2">⌚</div>
            ...
            <div className="BACKBTN_placeholder from-green-600 to-green-500 text-white rounded-2xl p-5 shadow-md">
              <div className="text-3xl mb-2">🎧</div>
            ...
            <div className="BACKBTN_placeholder from-gray-700 to-gray-600 text-white rounded-2xl p-5 shadow-md">
              <div className="text-3xl mb-2">🔧</div>
