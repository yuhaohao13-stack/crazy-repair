      ...
      <section className="py-14">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <a href="/other-repair/watch" className="bg-gradient-to-br from-blue-600 to-blue-500 text-white rounded-2xl p-5 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all block">
            ...
            <a href="/other-repair/samsung-watch" className="bg-gradient-to-br from-gray-600 to-gray-500 text-white rounded-2xl p-5 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all block">
              <div className="text-3xl mb-2">⌚</div>
            ...
            <a href="/other-repair/console" className="bg-gradient-to-br from-red-600 to-red-500 text-white rounded-2xl p-5 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all block">
              <div className="text-3xl mb-2">🎮</div>
            ...
            <a href="/other-repair/headphone" className="bg-gradient-to-br from-green-600 to-green-500 text-white rounded-2xl p-5 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all block">
              <div className="text-3xl mb-2">🎧</div>
            ...
            <a href="/other-repair/camera" className="bg-gradient-to-br from-purple-600 to-purple-500 text-white rounded-2xl p-5 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all block">
              <div className="text-3xl mb-2">📷</div>
            ...
            <a href="/other-repair/mods" className="bg-gradient-to-br from-gray-700 to-gray-600 text-white rounded-2xl p-5 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all block">
              <div className="text-3xl mb-2">🔧</div>
            ...
            <a href="/other-repair/smart-home" className="bg-gradient-to-br from-amber-600 to-amber-500 text-white rounded-2xl p-5 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all block">
              <div className="text-3xl mb-2">🔌</div>
            ...
            <a href="/other-repair/other" className="bg-gradient-to-br from-gray-600 to-gray-500 text-white rounded-2xl p-5 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all block">
              <div className="text-3xl mb-2">❓</div>
