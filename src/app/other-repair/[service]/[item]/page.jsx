...
const itemDetails = {
  ...
  'console-disc-drive': {
    title: '光驱维修',
    titleEn: 'Disc Drive Repair',
    icon: '💿',
    description: 'PS5/PS4光驱不读盘、卡盘、异响。光驱组件维修更换。',
    descriptionEn: 'PS5/PS4 disc drive not reading, stuck, noisy. Drive assembly repair.',
    details: [
      'PS5/PS4光驱不读盘/不吸盘',
      '光驱卡盘——碟片进去出不来回',
      '光驱异响——读盘噪音大、咔咔声',
    ...
    detailsEn: [
      'PS5/PS4 disc drive not reading/not pulling in disc',
      'Disc stuck inside drive',
      'Noisy drive — loud grinding, clicking sounds',
      'Drive assembly repair/replacement',
      'Includes disc drive test',
    ],
  },
  'console-power-supply': {
    title: '电源维修',
    titleEn: 'Power Supply Repair',
    icon: '🔌',
    description: 'PS5/PS4不开机、自动断电、电源灯不亮。电源板芯片级维修。',
    descriptionEn: 'PS5/PS4 no power, auto shutdown. Power board component-level repair.',
    details: [
      'PS5/PS4完全不开机——按电源键无反应',
      '开机后自动断电/自动关机',
      '电源指示灯不亮、闪烁异常',
      '电源板芯片级维修——更换电容/MOS管/电源IC等',
      '先检测报价，确认后维修',
    ],
    detailsEn: [
      'PS5/PS4 no power at all — no response to power button',
      'Auto shutdown shortly after power on',
      'Power LED not lit, abnormal blinking',
      'Power board chip-level repair — capacitor/MOSFET/power IC replacement',
      'Diagnose first, quote then repair',
    ],
  },
  'console-hdmi-port': {
    title: 'HDMI口维修',
    titleEn: 'HDMI Port Repair',
    icon: '📺',
    description: 'PS5/PS4 HDMI口松动、不显示、花屏。HDMI接口焊接更换。',
    descriptionEn: 'PS5/PS4 HDMI port loose, no display, garbled screen. Port soldering replacement.',
    details: [
      'PS5/PS4 HDMI口松动——插线一碰就断信号',
      '插上HDMI线无显示/无画面',
      '画面花屏、闪烁、颜色异常',
      'HDMI接口母座焊接更换',
      '主板HDMI相关电路元件检测',
    ...
    detailsEn: [
      'PS5/PS4 HDMI port loose — signal drops on cable touch',
      'No display when HDMI cable plugged in',
      'Garbled screen, flickering, color issues',
      'HDMI port socket soldering replacement',
      'HDMI-related circuit component inspection',
    ],
  },
  'console-psp-repair': {
    title: 'PSP/PSV维修',
    titleEn: 'PSP/PSV Repair',
    icon: '🎮',
    description: 'PSP/PSV屏幕更换、电池更换、充电口维修、按键失灵。',
    descriptionEn: 'PSP/PSV screen, battery, charging port, button repair.',
    details: [
      'PSP 3000/2000/1000 & PS Vita/PS Vita Slim 全系列维修',
      '屏幕碎裂/漏液——屏幕总成更换',
      '电池不耐用/鼓包——电池更换',
      '充电口松动/不充电——尾插维修',
      '按键失灵/导电胶老化——按键排线/导电胶更换',
      '摇杆漂移/不回中——摇杆模块更换',
    ],
    detailsEn: [
      'PSP 3000/2000/1000 & PS Vita/PS Vita Slim full series repair',
      'Cracked/leaking screen — LCD assembly replacement',
      'Battery drain/swelling — battery replacement',
      'Charging port loose/no charge — port repair',
      'Button not working/rubber pad aged — flex cable/pad replacement',
      'Joystick drift/not centering — joystick module replacement',
    ],
  },
  'headphone-battery': {
    title: '电池更换',
  ...
  'kindle-screen': {
    ...
    titleEn: 'Screen Replacement',
    icon: '📖',
    description: 'Kindle/Kobo/BOOX电子墨水屏碎裂、显示异常、局部不显示。E-ink屏幕更换。',
    descriptionEn: 'Kindle/Kobo/BOOX e-ink screen cracked, display issues. E-ink screen replacement.',
    details: [
      'Kindle第11代/Paperwhite/Oasis/Scribe 屏幕更换',
      'Kobo Clara/Libra/Sage 屏幕更换',
      '文石BOOX全系列屏幕更换',
      'E-ink电子墨水屏碎裂、条纹、白点、局部不显示',
      '更换含屏幕校准，恢复阅读体验',
    ],
    detailsEn: [
      'Kindle 11th gen/Paperwhite/Oasis/Scribe screen replacement',
      'Kobo Clara/Libra/Sage screen replacement',
      'BOOX full series screen replacement',
      'E-ink screen cracked, lines, white spots, partial display',
      'Screen calibration after replacement for best reading experience',
    ],
  },
  'kindle-battery': {
    title: '电池更换',
    titleEn: 'Battery Service',
    icon: '🔋',
    description: 'Kindle电池不耐用、充不进电、续航大幅下降。原装规格电池更换。',
    descriptionEn: 'Kindle battery drain, no charge, significantly reduced battery life. OEM spec battery.',
    details: [
      'Kindle全系列电池更换',
      '电池不耐用——充一次电用不到一周',
      '充不进电——插线没反应',
    ...
    detailsEn: [
      'Full Kindle series battery replacement',
      'Battery drain — less than a week on full charge',
      'Won\'t charge — no response when plugged in',
      'Significantly reduced battery life',
      'OEM spec battery with accurate capacity',
      'Includes battery health check',
    ],
  },
  'kindle-charging-port': {
    title: '充电口维修',
    titleEn: 'Charging Port',
    icon: '🔌',
    description: 'Kindle Micro-USB/Type-C口松动、不充电。焊接维修更换。',
    descriptionEn: 'Kindle Micro-USB/Type-C port loose, not charging. Solder repair.',
    details: [
      'Micro-USB口松动——充电线插不紧',
      'Type-C口松动——一碰就断充电',
      '完全不充电——插线无反应',
    ...
    detailsEn: [
      'Micro-USB port loose — cable won\'t stay in',
      'Type-C port loose — charging disconnects on touch',
      'No charge at all — no response',
      'Charging port socket soldering replacement',
      'Charging test after repair',
    ],
  },
  'kindle-system-issues': {
    title: '系统刷机',
    titleEn: 'System Flash',
    icon: '🔄',
    description: 'Kindle卡LOGO、死机、系统崩溃、无法开机。系统刷机修复。',
    descriptionEn: 'Kindle stuck on logo, frozen, crashed. System flash restore.',
    details: [
      '卡在Kindle开机LOGO界面不动',
      '开机到一半卡死、无限重启循环',
      '系统崩溃——屏幕显示异常、触摸无反应',
      '完全无法开机——黑屏但电脑能识别',
      '系统刷机修复——含数据备份尝试',
      '注意：刷机可能清除已购买书籍（可重新下载）',
    ],
    detailsEn: [
      'Stuck on Kindle boot logo',
      'Boot loop — reboots endlessly',
      'System crash — abnormal display, touch not working',
      'Power on but black screen — computer detects device',
      'System flash restore — includes data backup attempt',
      'Note: flashing may clear purchased books (re-downloadable)',
    ],
  },
}
...
const repairGroups = {
  ...
  console: ['console-joystick-drift', 'console-screen', 'console-battery', 'console-cleaning', 'console-mods', 'console-disc-drive', 'console-power-supply', 'console-hdmi-port', 'console-psp-repair'],
  ...
  other: ['other-screen', 'other-battery', 'other-charging-port', 'other-diagnosis', 'kindle-screen', 'kindle-battery', 'kindle-charging-port', 'kindle-system-issues'],
}
