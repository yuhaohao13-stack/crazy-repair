      ...
      <section className="bg-gradient-to-br from-blue-600 via-blue-500 to-blue-400 text-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-4"><a href="/other-repair" className="inline-flex items-center gap-1.5 text-white/60 hover:text-white text-sm font-medium transition-colors"><ArrowLeft size={14} /> {t('其他设备', 'Other Devices')}</a></div>
          ...
          <div className="flex gap-3 mt-6">
            ...
            <a href="https://wa.me/6596146709?text=Smartwatch手机需要维修" target="_blank" className="bg-green-500 text-white font-semibold px-5 py-2.5 rounded-xl hover:bg-green-600 shadow-lg">{t('💬 WhatsApp', '💬 WhatsApp')}</a>
          </div>
        </div>
      </section>
