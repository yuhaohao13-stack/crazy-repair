      ...
      <section className="bg-gradient-to-br from-green-600 via-green-500 to-green-400 text-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-4"><a href="/other-repair" className="inline-flex items-center gap-1.5 text-white/60 hover:text-white text-sm font-medium transition-colors"><ArrowLeft size={14} /> {t('其他设备', 'Other Devices')}</a></div>
          ...
          <div className="flex gap-3 mt-6">
            ...
            <a href="https://wa.me/6596146709?text=Headphones手机需要维修" target="_blank" className="bg-green-500 text-white font-semibold px-5 py-2.5 rounded-xl hover:bg-green-600 shadow-lg">{t('💬 WhatsApp', '💬 WhatsApp')}</a>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[{title:'耳机维修',titleEn:'Screen',desc:'Headphones Find/Reno/A系列耳机维修，OLED/LCD。碎裂漏液触摸不灵。'},
              ...
              {title:'后盖更换',titleEn:'Back Glass',desc:'Headphones玻璃后盖碎裂更换。'},
