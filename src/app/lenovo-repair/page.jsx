...
export default function LenovoRepair() {
  ...
  return (
      <Seo title="Ulenovo维修 - 电脑维修主板维修数据恢复 | Crazy维修威海" description="威海Ulenovo维修，Crazy维修2007年至今。专业维修Ulenovo笔记本/台式机，主板维修、屏幕更换、清灰、数据恢复。免费检测30天质保。" />
    <div className="min-h-screen bg-white">
      <Navbar />
      <Breadcrumb items={[{label:"电脑维修",labelEn:"Computer Repair",href:"/computer-repair"},{label:"Lenovo 维修",labelEn:"Lenovo Repair"}]} />
      ...
      <section className="py-16 bg-gradient-to-br from-blue-700 via-blue-600 to-blue-500 text-white text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">{t('需要Lenovo维修？找我', 'Need Lenovo Repair? Contact me')}</h2>
