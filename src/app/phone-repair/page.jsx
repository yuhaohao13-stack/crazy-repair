...
export default function PhoneRepair() {
  ...
  const brands = [
    ...
    { name: 'Samsung', page: '/samsung-repair', gradient: 'from-purple-600 to-purple-500', icon: '📱',
      models: 'S26/S25/S24/Z Fold 8/Flip 8/A系列', desc: t('三星AMOLED换屏、电池、主板芯片级维修', 'Samsung AMOLED repair specialist') },
    { name: 'Huawei', page: '/huawei-repair', gradient: 'from-red-600 to-red-500', icon: '📱',
      models: 'Mate 80/Mate 60/Pura 90/Nova 16/Nova', desc: t('华为Mate/P/Nova全系维修，鸿蒙刷机', 'Huawei Mate/P/Nova repair') },
    { name: 'Xiaomi', page: '/xiaomi-repair', gradient: 'from-orange-600 to-yellow-500', icon: '📱',
      models: '小米17/15/Redmi Note 17/K100/K系列', desc: t('小米/Redmi/Poco全系，性价比维修', 'Xiaomi/Redmi/Poco repair') },
    { name: 'OPPO', page: '/oppo-repair', gradient: 'from-green-600 to-green-500', icon: '📱',
      models: 'Find X9 Ultra/X8/Reno 16/A系列', desc: t('OPPO全系维修，屏碎、电池、充電口', 'OPPO series repair') },
    { name: 'vivo', page: '/vivo-repair', gradient: 'from-cyan-600 to-cyan-500', icon: '📱',
      models: 'X300/X200/X Fold6/iQOO Z11S/Neo11', desc: t('vivo/iQOO全系维修，屏下指纹修复', 'vivo/iQOO repair specialist') },
    { name: 'OnePlus', page: '/oneplus-repair', gradient: 'from-red-600 to-red-500', icon: '📱',
      models: 'OnePlus 15/13/12/Open 2/Nord/Ace', desc: t('一加全系维修，性价比之选', 'OnePlus full repair service') },
    { name: 'Honor', page: '/honor-repair', gradient: 'from-teal-600 to-teal-500', icon: '📱',
      models: 'Magic 8/Robot Phone/600/X80 Pro Max', desc: t('荣耀全系维修，屏幕电池主板', 'Honor full repair service') },
    { name: 'Google Pixel', page: '/google-repair', gradient: 'from-gray-600 to-gray-500', icon: '📱',
      models: 'Pixel 11/10/9/8/7系列', desc: t('Google Pixel全系维修', 'Google Pixel repair') },
    { name: 'Realme', page: '/realme-repair', gradient: 'from-yellow-600 to-amber-500', icon: '📱',
      models: 'GT 8/GT 7/真我 16/14/Note 80/Q系列', desc: t('Realme全系性价比维修', 'Realme affordable repair') },
    ...
    { name: 'Motorola', page: '/#services', gradient: 'from-indigo-600 to-indigo-500', icon: '📱',
      models: 'Moto g37/Edge 70/Edge 50/Razr 系列', desc: t('摩托罗拉全系维修', 'Motorola full repair') },
