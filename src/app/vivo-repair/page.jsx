...
export default function VIVORepair() {
  ...
  return (
    <>
      <Seo title="Vivo手机维修 - 换屏换电池主板维修 | Crazy维修威海" description="威海Vivo手机维修，换屏、换电池、主板维修、进水维修、摄像头维修。Crazy维修2007年至今，免费检测30天质保。" />
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-3 mt-6">
              <button onClick={() => setShowContact(true)} className="bg-white text-cyan-600 font-semibold px-6 py-3 rounded-xl hover:bg-cyan-50 transition-colors shadow-lg">
                {t('📱 立即咨询', '📱 Contact Now')}
              </button>
            </div>
          </div>
      ...
      <section className="py-16 bg-gradient-to-br from-cyan-700 via-cyan-600 to-cyan-500 text-white text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button onClick={() => setShowContact(true)} className="bg-white text-cyan-600 font-semibold px-8 py-4 rounded-xl hover:bg-cyan-50 transition-colors shadow-lg text-lg">
                {t('📱 立即咨询', '📱 Contact Now')}
              </button>
          </div>
        </div>
