...
export default function RealmeRepair() {
  ...
  const models = [
    t('Realme 16 Pro / 16', 'Realme 16 Pro / 16'),
  ...
  return (
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-gradient-to-br from-yellow-600 via-amber-500 to-orange-500 text-white text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">{t('需要Realme维修？找我', 'Need Realme Repair? Contact me')}</h2>
          <p className="text-amber-100 mb-8">{t('免费检测，发照片就能初步判断', 'Free diagnosis, send a photo for a quick check')}</p>
