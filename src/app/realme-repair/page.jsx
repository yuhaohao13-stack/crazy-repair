    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-yellow-600 via-amber-500 to-orange-500 text-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-14">
          <h1 className="text-3xl sm:text-5xl font-bold mb-3">{t('Realme 维修', 'Realme Repair')}</h1>
          <p className="text-white/80 text-lg mb-4">{t('Realme 全系列专业维修 | 威海', 'Realme All Series | Weihai')}</p>
          <p className="text-white/80 max-w-2xl">{t('Realme手机——屏幕碎了、电池不耐用了、充电口坏了，拿来给我看看。2007年至今奋斗在维修一线。', 'Realme phone repair — screen, battery, port. On the job since 2007.')}</p>
          <div className="flex gap-3 mt-6">
            <button onClick={() => setShowContact(true)} className="bg-white text-amber-600 font-semibold px-5 py-2.5 rounded-xl hover:bg-amber-50 shadow-lg">{t('📱 微信咨询', '📱 WeChat')}</button>
            <a href="https://wa.me/6596146709?text=Realme手机需要维修" target="_blank" className="bg-green-500 text-white font-semibold px-5 py-2.5 rounded-xl hover:bg-green-600 shadow-lg">{t('💬 WhatsApp', '💬 WhatsApp')}</a>
          </div>
        </div>
      </section>
