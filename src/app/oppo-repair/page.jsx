...
export default function OPPORepair() {
  ...
  const models = [
    t('Find X9 Ultra / X9s Pro / X9 / X9 Pro', 'Find X9 Ultra / X9s Pro / X9 / X9 Pro'),
    t('Find N6 / N5 / N4 / N3 Flip / N2 Flip', 'Find N6 / N5 / N4 / N3 Flip / N2 Flip'),
    ...
    t('A系列 A7 Pro Max / A60 / A58 / A57 / A56 / A55', 'A series A7 Pro Max / A60 / A58 / A57 / A56 / A55'),
    t('OPPO Pad 6 / Pad / Pad 3 / Pad Air / Pad 2', 'OPPO Pad 6 / Pad / Pad 3 / Pad Air / Pad 2'),
    t('一加手机（OPPO系兼容维修）', 'OnePlus phones (OPPO platform compatible)'),
  ]

  return (
    <>
      <Seo title="Oppo手机维修 - 换屏换电池主板维修 | Crazy维修威海" description="威海Oppo手机维修，换屏、换电池、主板维修、进水维修、摄像头维修。Crazy维修2007年至今，免费检测30天质保。" />
    <div className="min-h-screen bg-white">
      <Navbar />
      <Breadcrumb items={[{label:"手机维修",labelEn:"Phone Repair",href:"/phone-repair"},{label:"OPPO 维修",labelEn:"OPPO Repair"}]} />
      ...
      <section className="py-16 bg-gradient-to-br from-green-600 via-green-500 to-green-400 text-white text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">{t('需要OPPO维修？找我', 'Need OPPO Repair? Contact me')}</h2>
          <p className="text-green-200 mb-8">{t('免费检测，发照片就能初步判断', 'Free diagnosis, send a photo for a quick check')}</p>
