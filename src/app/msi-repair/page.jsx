...
export default function MSIRepair() {
  ...
  return (
    <>
      <Seo title="Umsi维修 - 电脑维修主板维修数据恢复 | Crazy维修威海" description="威海Umsi维修，Crazy维修2007年至今。专业维修Umsi笔记本/台式机，主板维修、屏幕更换、清灰、数据恢复。免费检测30天质保。" />
    <div className="min-h-screen bg-white">
      <Navbar />
      <Breadcrumb items={[{label:"电脑维修",labelEn:"Computer Repair",href:"/computer-repair"},{label:"微星 维修",labelEn:"MSI Repair"}]} />
      ...
      <section className="py-16 bg-gradient-to-br from-red-700 via-red-600 to-red-500 text-white text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">{t('需要MSI维修？找我', 'Need MSI Repair? Contact me')}</h2>
