  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-blue-700 via-blue-600 to-blue-500 text-white relative">
        {/* 手机端右上角站长风采 — 虚影气泡 */}
        <div className="sm:hidden absolute top-14 right-2 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 overflow-hidden" style={{ maxWidth: '260px' }}>
          <div className="flex flex-col">
            <span className="text-[9px] text-white/70 tracking-wider px-2 pt-1 pb-0.5 leading-tight">🧑 站长浩哥风采</span>
            <div className="flex">
              <img src="/images/hao-tiananmen.jpg?v=2" alt="站长浩哥风采" className="object-cover" style={{ height:'90px', width:'auto' }} />
              <div className="flex-1 flex items-center justify-center p-1.5 relative overflow-hidden">
                ...
                <div className="relative bg-white/85 backdrop-blur-md rounded-xl px-2 py-1.5 text-center shadow-sm z-10">
                  <div className="text-[10px] font-medium text-[#333] leading-tight">
                    祝站长浩哥<br />
                    身体健康 · 日日暴富<br />
                    顺风顺水 · 天天开心<br />
                    🎉
          ...
          <div className="grid sm:grid-cols-2 gap-10 items-center">
            ...
            <div className="hidden sm:flex flex-col gap-3 justify-center">
              ...
              <div className="flex gap-3">
                <div className="flex-1 bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 text-center flex flex-col justify-center">
                  <div className="text-4xl mb-2">🔧</div>
                  <p className="text-base font-semibold">{t('专业维修', 'Pro Repair')}</p>
                  <p className="text-blue-200 text-xs mt-0.5">{t('手机 · 电脑 · 平板 · 数码', 'Phone · PC · Tablet · Gadgets')}</p>
                </div>
                <div className="flex-1 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 overflow-hidden" style={{ width: '280px' }}>
                  <div className="py-1.5 text-[10px] font-medium text-white/80 tracking-wider border-b border-white/10">
                    🧑 站长浩哥风采
                  </div>
                  <div className="flex">
                    <img
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              ...
              <ul className="space-y-1.5 text-sm text-gray-600">
                <li className="flex items-start gap-2"><span className="text-blue-400 mt-0.5">▸</span><a href="/other-repair/watch" className="hover:text-blue-600 transition-colors">{t('Apple Watch Ultra 3 / Ultra 2 / Ultra (49mm)', 'Apple Watch Ultra 3 / Ultra 2 / Ultra (49mm)')}</a></li>
                ...
                <li className="flex items-start gap-2"><span className="text-blue-400 mt-0.5">▸</span><a href="/other-repair/samsung-watch" className="hover:text-blue-600 transition-colors">{t('Samsung Galaxy Watch 9 / Ultra 2 全系', 'Samsung Galaxy Watch 9 / Ultra 2 all series')}</a></li>
              </ul>
            </div>
            {/* Mac */}
            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
