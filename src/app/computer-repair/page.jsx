...
export default function ComputerRepair() {
  ...
  const brands = [
    ...
    { name: 'Acer 宏基', page: '/#services', gradient: 'from-green-700 to-green-600', icon: '💻',
      models: 'Predator、Nitro、Swift、Aspire', desc: t('宏基笔记本台式机全系维修', 'Acer laptop & desktop repair') },
    { name: 'MSI 微星', page: '/#services', gradient: 'from-red-700 to-red-600', icon: '💻',
    ...
    { name: '小米/RedmiBook', page: '/#services', gradient: 'from-orange-600 to-orange-500', icon: '💻',
      models: '小米笔记本/RedmiBook全系', desc: t('小米笔记本维修', 'Xiaomi laptop repair') },
    { name: '神舟 Hasee', page: '/#services', gradient: 'from-indigo-700 to-indigo-600', icon: '💻',
