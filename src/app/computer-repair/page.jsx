...
export default function ComputerRepair() {
  ...
  const brands = [
    ...
    { name: 'Huawei MateBook', page: '/huawei-repair', gradient: 'from-red-600 to-red-500', icon: '💻',
      models: 'MateBook X Pro/14/16/D系列', desc: t('华为笔记本维修升级', 'Huawei laptop repair') },
    { name: '荣耀 Honor', page: '/#services', gradient: 'from-teal-600 to-teal-500', icon: '💻',
      models: 'MagicBook 14/16 / X14/X16 2026全系', desc: t('荣耀笔记本维修', 'Honor laptop repair') },
    { name: '小米/RedmiBook', page: '/xiaomi-repair', gradient: 'from-orange-600 to-orange-500', icon: '💻',
      models: '小米/RedmiBook 2026全系', desc: t('小米笔记本维修', 'Xiaomi laptop repair') },
  ...
  return (
    <>
      <Seo title="电脑维修 - 换屏换电池主板维修 | Crazy维修威海" description="威海电脑维修，Crazy维修2007年至今。专业维修电脑，免费检测、价格透明、30天质保。环翠区西门31号。" />
    <div className="min-h-screen bg-white">
      <Navbar />
      <Breadcrumb items={[{label:"电脑维修",labelEn:"Computer Repair"}]} />
