...
export default function KindleRepair() {
  ...
  return (
    <>
      <Seo title="Kindle维修 - 换屏换电池主板维修 | Crazy维修威海" description="威海Kindle维修，Crazy维修2007年至今。专业维修Kindle，免费检测、价格透明、30天质保。环翠区西门31号。" />
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((s, i) => (
              <a key={i} href={'/other-repair/other/kindle-' + s.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden hover:shadow-md transition-all group block">
                <div className="p-6">
                  ...
                  <div className="mt-4 text-amber-600 text-xs font-medium flex items-center gap-1">{t('查看详情 →', 'View Details →')}</div>
                </div>
              </a>
            ))}
          </div>
