      ...
      <section className="bg-gradient-to-br from-green-700 via-green-600 to-green-500 text-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-4"><a href="/computer-repair" className="inline-flex items-center gap-1.5 text-white/60 hover:text-white text-sm font-medium transition-colors"><ArrowLeft size={14} /> {t('电脑品牌', 'Computer Brands')}</a></div>
          ...
          <div className="flex gap-3 mt-6">
            ...
            <a href="https://wa.me/6596146709?text=Acer手机需要维修" target="_blank" className="bg-green-500 text-white font-semibold px-5 py-2.5 rounded-xl hover:bg-green-600 shadow-lg">{t('💬 WhatsApp', '💬 WhatsApp')}</a>
          </div>
        </div>
      </section>
      <section className="py-14">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[{title:'屏幕更换',titleEn:'Screen',desc:'Acer Find/Reno/A系列屏幕更换，OLED/LCD。碎裂漏液触摸不灵。'},
              {title:'电池更换',titleEn:'Battery',desc:'Acer电池不耐用、鼓包、充不进电。原装规格电池。'},
              {title:'充电口维修',titleEn:'Charging Port',desc:'Type-C口松动、接触不良、只能慢充。'},
              {title:'主板维修',titleEn:'Motherboard',desc:'不开机、重启、充电IC故障、无服务。芯片级维修。'},
              {title:'后盖更换',titleEn:'Back Glass',desc:'Acer玻璃后盖碎裂更换。'},
