      ...
      <section className="py-16 bg-gradient-to-br from-purple-700 via-purple-600 to-purple-500 text-white text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button onClick={() => setShowContact(true)} className="bg-white text-purple-600 font-semibold px-8 py-4 rounded-xl hover:bg-purple-50 transition-colors shadow-lg text-lg">
                {t('📱 立即咨询', '📱 Contact Now')}
              </button>
          </div>
        </div>
